...
<template>
  <Hero class="bg-hero" color="grey" alignment="center" size="fullheight">
    <template #body>
      <div class="columns is-vcentered mt-12">
        <!--Hero Content-->
        <div class="column is-relative">
          <div class="mx-auto max-w-6 mb-4">
            <Title tag="h1" :size="1" weight="bold" narrow>
              <span>
                The State of
            ...
            <Countdown date="Sep 28, 2022" />
          </div>

          <!--Buttons-->
          <div class="buttons is-relative z-1">
            <Button color="primary" :long="2" raised bold>Get Tickets</Button>
            <Button elevated bold :long="2">Schedule</Button>
          </div>
        </div>
      </div>
    </template>
    <template #footer>
      <div class="mx-auto max-w-8">
        <p class="paragraph rem-100 has-text-centered">We are supported by</p>
