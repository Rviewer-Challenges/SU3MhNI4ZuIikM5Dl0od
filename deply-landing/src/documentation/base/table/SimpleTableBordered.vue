...
import { tableProps, tableBordered } from '/@src/data/docs/base/table'
</script>

<template>
  <Section id="table-bordered-demo" bordered-bottom>
    <Container>
      <div class="mx-auto max-w-9">
        <div class="pt-4 pb-6">
          <DemoTitle title="Table Border" subtitle="Table border variation" />
        ...
        <DemoTabs>
          <template #code>
            <PrismCode language="html" :code="tableBordered" />
          </template>
          <template #props>
            <PrismCode language="javascript" :code="tableProps" />
          </template>
          <template #sample>
          ...
          <template #usage>
            <p class="paragraph rem-95">
              Vulk's table is an extremely versatile component split into
              ...
              and
              <code>td</code>
              . The table component is bordered by default, as the
              <code>bordered</code>
              prop is set to
              <code>true</code>
              by default. You can remove borders by setting it to
              <code>false</code>
              . You can also create a striped table using the
              <code>striped</code>
              prop. You can of course mix any of those styles. Note that you can
              also make a table horizontally scrollable by adding the
