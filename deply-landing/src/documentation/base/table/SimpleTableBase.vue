...
import { tableProps, tableBase } from '/@src/data/docs/base/table'
</script>

<template>
  <Section id="table-base-demo" bordered-bottom>
    <Container>
      <div class="mx-auto max-w-9">
        <div class="pt-4 pb-6">
          <DemoTitle title="Table" subtitle="Table base variation" />
        ...
        <DemoTabs>
          <template #code>
            <PrismCode language="html" :code="tableBase" />
          </template>
          <template #props>
