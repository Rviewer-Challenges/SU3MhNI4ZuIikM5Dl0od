...
import { cardProps, cardShapes } from '/@src/data/docs/base/card'
</script>

<template>
  <Section id="card-shapes-demo" bordered-bottom>
    <Container>
      <div class="mx-auto max-w-6">
        <div class="pt-4 pb-6">
          <DemoTitle title="Card Shapes" subtitle="Available card shapes" />
        ...
        <DemoTabs>
          <template #code>
            <PrismCode language="html" :code="cardShapes" />
          </template>
          <template #props>
          ...
          <template #usage>
            <p class="paragraph rem-95">
              ...
              cards come in different flavors. You can control card shapes using
              the
              <code>shape</code>
