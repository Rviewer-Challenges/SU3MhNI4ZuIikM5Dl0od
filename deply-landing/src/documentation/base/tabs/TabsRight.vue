...
import { tabsProps, tabsRight } from '/@src/data/docs/base/tabs'
</script>

<template>
  <Section id="tabs-right-demo" bordered-bottom>
    <Container>
      <div class="mx-auto max-w-6">
        <div class="pt-4 pb-6">
          <DemoTitle title="Right Tabs" subtitle="Tabs right variation" />
          <div class="pt-4">
            <Tabs
              alignment="right"
              selected="overview"
        ...
        <DemoTabs>
          <template #code>
            <PrismCode language="html" :code="tabsRight" />
          </template>
          <template #props>
