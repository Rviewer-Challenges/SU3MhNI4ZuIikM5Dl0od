...
import {
  ...
  featureBlockAProps,
  featureBlockASample,
} from '/@src/data/docs/advanced/feature/blockA'
</script>
...
<template>
  ...
  <Section id="block-a-props" bordered-bottom>
    <Container>
      ...
      <DemoTabs>
        <template #code>
          <PrismCode language="html" :code="featureBlockA" />
        </template>
        <template #props>
          <DemoProps :props="featureBlockAProps.props" />
        </template>
        <template #sample>
          <PrismCode language="javascript" :code="featureBlockASample" />
        </template>
        <template #usage>
