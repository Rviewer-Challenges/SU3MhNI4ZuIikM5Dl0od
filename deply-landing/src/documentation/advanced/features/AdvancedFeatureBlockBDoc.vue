...
import { marketingProcess } from '/@src/data/pages/marketing'
import {
  featureBlockB,
  featureBlockBProps,
  featureBlockBSample,
} from '/@src/data/docs/advanced/feature/blockB'
</script>
...
<template>
  <Section id="block-b-demo" bordered-bottom>
    <Container>
      ...
      <ProcessSection :steps="marketingProcess.steps" />
    </Container>
  </Section>
  ...
  <Section id="block-b-props" bordered-bottom>
    <Container>
      ...
      <DemoTabs>
        <template #code>
          <PrismCode language="html" :code="featureBlockB" />
        </template>
        <template #props>
          <DemoProps :props="featureBlockBProps.props" />
        </template>
        <template #sample>
          <PrismCode language="javascript" :code="featureBlockBSample" />
        </template>
        <template #usage>
